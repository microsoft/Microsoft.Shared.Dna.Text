...
1. [Report defects and provide suggestions](https://github.com/Microsoft/Microsoft.Shared.Dna.Text/issues).  
    If you believe you have found a security vulnerability in this project, please follow [these steps](https://technet.microsoft.com/en-us/security/ff852094.aspx) to report it. For more information on how vulnerabilities are disclosed, see [Coordinated Vulnerability Disclosure](https://technet.microsoft.com/en-us/security/dn467923).
2. Review [pull requests](https://github.com/Microsoft/Microsoft.Shared.Dna.Text/pulls), even if it's just to verify that the defect was fixed or that the feature was implemented as intended.
3. Contribute fixes and features:
    1. Fork this repository (https://github.com/Microsoft/Microsoft.Shared.Dna.Text/fork) and clone it.
    ...
    5. Create a new Pull Request (https://github.com/Microsoft/Microsoft.Shared.Dna.Text/pulls).
